...
-- SAVE TABLE (PLEASE REPLACE "Dflt._pk_20210408_EP_CRC_PULL" WITH THE NAME YOU WANT)
-- ================================================================================================

-- Create tables 
IF (OBJECT_ID('Dflt._pk_20210408_EP_CRC_PULL') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._pk_20210408_EP_CRC_PULL
	END

CREATE TABLE Dflt._pk_20210408_EP_CRC_PULL
(
...
INSERT INTO Dflt._pk_20210408_EP_CRC_PULL
SELECT DISTINCT
	CONCAT('''', fin.PatientSSN, '''')
	,CAST(fin.DiagnosisEventDateTime AS DATE)
	,CONCAT('''', reg.CitytownAtDX, ', ', '''', reg.StateatdXX)

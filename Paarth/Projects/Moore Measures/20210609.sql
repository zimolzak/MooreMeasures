...
IF (OBJECT_ID('Dflt._2pk_LCa2019_ParameterTable') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_ParameterTable
	END

CREATE TABLE Dflt._2pk_LCa2019_ParameterTable
(
...
INSERT INTO Dflt._2pk_LCa2019_ParameterTable
(
	Search_Start
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10CMCodes') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10CMCodes
	END

CREATE TABLE Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10CMCodes
(
	ICD10CMCode VARCHAR(50)
)

IF (OBJECT_ID('Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10PCSCodes') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10PCSCodes
	END

CREATE TABLE Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10PCSCodes
(
	ICD10PCSCode VARCHAR(50)
)

-- Compile codes
INSERT INTO Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10CMCodes
SELECT ex.[ICD-10-CM Code]
FROM Dflt._ppku_EncounterTypeICD_T1_Plan_T1_AlwaysPlannedConditions AS ex


INSERT INTO Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10PCSCodes
...
SET @STEP01_SearchStart = (SELECT params.Search_Start FROM Dflt._2pk_LCa2019_ParameterTable AS params)
SET @STEP01_SearchEnd = DATEADD(MONTH, (SELECT params.Search_Length_Months FROM Dflt._2pk_LCa2019_ParameterTable AS params), (SELECT params.Search_Start FROM Dflt._2pk_LCa2019_ParameterTable AS params))
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP01_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP01_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP01_Z
(
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP01_Z
SELECT DISTINCT
	sp.PatientSSN
	,owl.PatientSID
	,owl.VisitSID 
...
SET @STEP02_ExcludeStart = DATEADD(YEAR, (SELECT params.Exclude_Length_Years FROM Dflt._2pk_LCa2019_ParameterTable AS params), (SELECT params.Search_Start FROM Dflt._2pk_LCa2019_ParameterTable AS params))
SET @STEP02_ExcludeEnd = (SELECT params.Search_Start FROM Dflt._2pk_LCa2019_ParameterTable AS params)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP02_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP02_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP02_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
-- Get outpatient encounters with a diagnostic code associated with the cancer of study
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP02_Z
SELECT DISTINCT
	sp.PatientSSN
	,owl.PatientSID
	,owl.VisitSID
...
WHERE
	...
	(
		select t.PatientSID
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP01_Z AS t
	)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP03_A') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP03_A
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP03_A
(
	PatientSSN VARCHAR(10)
)

-- Get SSNs of patients in the search period that had cancer records in the exclusion period
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP03_A
SELECT DISTINCT srch.PatientSSN
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP01_Z AS srch INNER JOIN Dflt._2pk_LCa2019_INCLUSION_STEP02_Z AS exc ON
	(
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP03_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP03_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP03_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP03_Z
SELECT DISTINCT
	srch.PatientSSN
	,srch.PatientSID
	...
	,srch.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP01_Z AS srch
WHERE
	srch.PatientSSN NOT IN
	(
		SELECT t.PatientSSN
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP03_A AS t
	)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP04_A') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP04_A
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP04_A
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP04_A
SELECT DISTINCT
	dx.PatientSSN
	,dx.PatientSID
	...
	,dx.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP03_Z AS dx
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP04_B') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP04_B
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP04_B
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP04_B
SELECT DISTINCT
	dx.PatientSSN
	,dx.PatientSID
	,dx.DiagnosisEventSID
...
WHERE
	...
	(
		SELECT t.PatientSSN
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP04_A AS t
	)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP04_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP04_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP04_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP04_Z
SELECT DISTINCT
	reg_dx.PatientSSN
	,reg_dx.PatientSID
	...
	,reg_dx.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP04_A AS reg_dx
WHERE
	reg_dx.DiagnosisEventDateTime = 
	(
...
SELECT DISTINCT
	...
	,icd_dx.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP04_B AS icd_dx
WHERE
	icd_dx.DiagnosisEventDateTime = 
	(
		SELECT TOP 1 t.DiagnosisEventDateTime
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP04_B AS t
...
SET @STEP05_SearchStart = DATEADD(DAY, (SELECT params.Lookback_Length_Days FROM Dflt._2pk_LCa2019_ParameterTable AS params), (SELECT params.Search_Start FROM Dflt._2pk_LCa2019_ParameterTable AS params))
SET @STEP05_SearchEnd = DATEADD(MONTH, (SELECT params.Search_Length_Months FROM Dflt._2pk_LCa2019_ParameterTable AS params), (SELECT params.Search_Start FROM Dflt._2pk_LCa2019_ParameterTable AS params))
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_A') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_A
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_A
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,ECEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_A
SELECT DISTINCT
	sp.PatientSSN
	,inp.PatientSID
	,inp.InpatientSID
...
WHERE
	...
	(
		SELECT t.PatientSSN
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP04_Z AS t
	)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_B') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_B
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_B
(
	PatientSSN VARCHAR(10)
	,ECEventSID BIGINT
)
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_B
SELECT DISTINCT
	ec.PatientSSN
	,ec.ECEventSID
FROM Dflt._2pk_LCa2019_INCLUSION_STEP05_A AS ec INNER JOIN Src.Inpat_InpatientDiagnosis AS inpd ON 
	(
...
WHERE
	REPLACE(icd10.ICD10Code, '.', '') IN 
		(
			...
			FROM Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10CMCodes AS t
		)
...
SELECT DISTINCT
	ec.PatientSSN
	,ec.ECEventSID
FROM Dflt._2pk_LCa2019_INCLUSION_STEP05_A AS ec INNER JOIN Src.Inpat_InpatientICDProcedure AS inpip ON 
	(
...
WHERE
	REPLACE(icd10p.ICD10ProcedureCode, '.', '') IN 
		(
			...
			FROM Dflt._2pk_LCa2019_SETUP_PlannedHospitalization_ICD10PCSCodes AS t
		)
...
-- Create tables 
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_C') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_C
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_C
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,ECEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_C
SELECT DISTINCT
	sp.PatientSSN
	,edl.PatientSID
	,edl.VisitSID
...
-- Create tables 
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_D') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_D
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_D
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,InpSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_D
SELECT DISTINCT
	sp.PatientSSN
	,inp.PatientSID
	,inp.InpatientSID
...
-- Create tables 
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_E') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_E
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_E
(
	ECEventSID BIGINT
)
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_E
SELECT DISTINCT
	prev.ECEventSID
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP05_C AS prev INNER JOIN Dflt._2pk_LCa2019_INCLUSION_STEP05_D AS ex_inp ON
	(
...
-- Create tables 
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_F') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_F
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_F
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,ECEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_F
SELECT DISTINCT
	prev.PatientSSN
	,prev.PatientSID
	,prev.ECEventSID
	...
	,prev.ECEventEndDateTime
	,prev.TypeOfEvent
FROM Dflt._2pk_LCa2019_INCLUSION_STEP05_C AS prev
WHERE
	prev.ECEventSID NOT IN 
	(
		SELECT t.ECEventSID
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP05_E AS t
	)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP05_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP05_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,ECEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP05_Z
SELECT DISTINCT
	ec.PatientSSN
	,ec.PatientSID
	,ec.ECEventSID
	...
	,ec.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP05_A AS ec
WHERE
	ec.ECEventSID NOT IN
	(
		SELECT pec.ECEventSID
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP05_B AS pec
	)
...
SELECT DISTINCT
	...
	,ec.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP05_F AS ec
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP06_A') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP06_A
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP06_A
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP06_A
SELECT DISTINCT
	dx.PatientSSN
	,dx.PatientSID
	,dx.DiagnosisEventSID
	...
	,ec.TypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP04_Z AS dx INNER JOIN Dflt._2pk_LCa2019_INCLUSION_STEP05_Z AS ec ON
	(
		dx.PatientSSN = ec.PatientSSN
		AND
		ec.ECEventDateTime BETWEEN
			DATEADD(DAY, (SELECT params.Lookback_Length_Days FROM Dflt._2pk_LCa2019_ParameterTable AS params), dx.DiagnosisEventDateTime)
			AND
			dx.DiagnosisEventDateTime
	)
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_STEP06_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_STEP06_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_STEP06_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_STEP06_Z
SELECT DISTINCT
	ecdx.PatientSSN
	,ecdx.PatientSID
	...
	,ecdx.ECTypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP06_A AS ecdx
WHERE
	ecdx.ECEventDateTime = 
	(
		SELECT TOP 1 t.ECEventDateTime
		FROM Dflt._2pk_LCa2019_INCLUSION_STEP06_A AS t
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_INCLUSION_FINAL') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_INCLUSION_FINAL
	END

CREATE TABLE Dflt._2pk_LCa2019_INCLUSION_FINAL
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_INCLUSION_FINAL
SELECT DISTINCT
	prev.PatientSSN
	,prev.PatientSID
	...
	,prev.ECTypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_STEP06_Z AS prev
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_EXCLUSION_STEP01_A') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_EXCLUSION_STEP01_A
	END

CREATE TABLE Dflt._2pk_LCa2019_EXCLUSION_STEP01_A
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_EXCLUSION_STEP01_A
SELECT DISTINCT
	inc.PatientSSN
	,inc.PatientSID
	...
	,'OUTPATIENT'
FROM
	Dflt._2pk_LCa2019_INCLUSION_FINAL AS inc INNER JOIN Src.SPatient_SPatient AS sp ON
	(
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_EXCLUSION_STEP01_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_EXCLUSION_STEP01_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_EXCLUSION_STEP01_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_EXCLUSION_STEP01_Z
SELECT DISTINCT
	hx.*
	,DATEDIFF(MONTH, hx.HistoricalEventDateTime, hx.DiagnosisEventDateTime)
FROM
	Dflt._2pk_LCa2019_EXCLUSION_STEP01_A AS hx
WHERE
	hx.HistoricalEventDateTime = 
	(
		SELECT TOP 1 t.HistoricalEventDateTime
		FROM Dflt._2pk_LCa2019_EXCLUSION_STEP01_A AS t
...
SET @STEP02_CareHxThreshold = (SELECT params.CareHx_Length_Months FROM Dflt._2pk_LCa2019_ParameterTable AS params)

PRINT CHAR(13) + CHAR(10) + 'eStep 02 - Minimum Care History Threshold: ' + CAST(@STEP02_CareHxThreshold AS VARCHAR)

IF (OBJECT_ID('Dflt._2pk_LCa2019_EXCLUSION_STEP02_Z') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_EXCLUSION_STEP02_Z
	END

CREATE TABLE Dflt._2pk_LCa2019_EXCLUSION_STEP02_Z
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_EXCLUSION_STEP02_Z
SELECT DISTINCT
	prev.PatientSSN
	,prev.PatientSID
	,prev.DiagnosisEventSID
	...
	,prev.ECTypeOfEvent
FROM
	Dflt._2pk_LCa2019_INCLUSION_FINAL AS prev INNER JOIN Dflt._2pk_LCa2019_EXCLUSION_STEP01_Z AS ehx ON
	(
...
IF (OBJECT_ID('Dflt._2pk_LCa2019_EXCLUSION_FINAL') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_EXCLUSION_FINAL
	END

CREATE TABLE Dflt._2pk_LCa2019_EXCLUSION_FINAL
(
	PatientSSN VARCHAR(10)
	,PatientSID BIGINT
	,DiagnosisEventSID BIGINT
...
INSERT INTO Dflt._2pk_LCa2019_EXCLUSION_FINAL
SELECT DISTINCT
	exc.PatientSSN
	,exc.PatientSID
	...
	,exc.ECEventDateTime
	,exc.ECTypeOfEvent
FROM Dflt._2pk_LCa2019_EXCLUSION_STEP02_Z AS exc
...
-- SAVE TABLE (PLEASE REPLACE "Dflt._2pk_LCa2019_OUTPUT_TABLE" WITH THE NAME YOU WANT)
-- ================================================================================================

IF (OBJECT_ID('Dflt._2pk_LCa2019_OUTPUT_TABLE') IS NOT NULL)
	BEGIN
		DROP TABLE Dflt._2pk_LCa2019_OUTPUT_TABLE
	END

CREATE TABLE Dflt._2pk_LCa2019_OUTPUT_TABLE
(
...
INSERT INTO Dflt._2pk_LCa2019_OUTPUT_TABLE
SELECT
	...
	,prev.ECTypeOfEvent
FROM
	Dflt._2pk_LCa2019_EXCLUSION_FINAL AS prev LEFT JOIN Src.Oncology_Oncology_Primary_165_5 AS reg ON 
	(
...
SELECT
	...
	,prev.ECTypeOfEvent
FROM
	Dflt._2pk_LCa2019_EXCLUSION_FINAL AS prev LEFT JOIN Src.Inpat_Inpatient AS d_inp ON
		(
...
SELECT
	...
	,prev.ECTypeOfEvent
FROM
	Dflt._2pk_LCa2019_EXCLUSION_FINAL AS prev LEFT JOIN Src.Outpat_Workload AS d_owl ON
		(
...
FROM Dflt._2pk_LCa2019_OUTPUT_TABLE
